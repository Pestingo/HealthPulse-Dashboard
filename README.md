...
# HealthPulse - Your Personal Health & Wellness Dashboard
...
The application is pre-configured to run out of the box.

The main page for the application is located at `src/app/page.tsx`. This is a great place to start exploring the code and making changes. All components are located within the `src/components` directory.
